...
const ShoppingCart = () => {
    ...
    useEffect(() => {
            function setPriceToCart() {
                ...
                shoppingList.forEach(x => totalPriceCart += x.quantity * x.price)
    ...
    return (
        <>
            {showPayWith && <PopUpPayment setShowPayment={setShowPayWith} amount={totalPrice}/>}
                                ...
                                <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                                    <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                                        ...
                                        <div className="flex flex-col w-full bg-white">
                                            <div className="sm:flex  sm:justify-center  w-full bg-white">
                                                <div className="flex flex-col sm:w-1/2 justify-start items-center mt-4">
                                                    ...
                                                    <div
                                                        ...
                                                        <div className="flex items-center justify-start  w-3/5 h-full">
                                                            <p
                                            ...
                                            <button
                                                className="text-sm text-white bg-black rounded-md border-solid border-2 border-white py-3  px-4"
