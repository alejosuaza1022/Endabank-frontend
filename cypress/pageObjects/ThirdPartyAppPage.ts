...
export default class basePage {
    ...
    private NIKE_AIR_96_LABEL: string = ':nth-child(3) > :nth-child(1) > .flex > .ml-3 > .text-gray-900'
    private AIR_FORCE_1_LABEL: string = ':nth-child(2) > :nth-child(1) > .flex > .ml-3 > .text-gray-900'
    private JORDAN_RACER_LABEL: string = ':nth-child(1) > :nth-child(1) > .flex > .ml-3 > .text-gray-900'
    private AIR_JORDAN_11_LABEL: string = ':nth-child(8) > :nth-child(1) > .flex > .ml-3 > .text-gray-900'
    private AIR_JORDAN_1_LABEL: string = ':nth-child(6) > :nth-child(1) > .flex > .ml-3 > .text-gray-900'
    private JORDAN_RETRO_4_LABEL: string = ':nth-child(7) > :nth-child(1) > .flex > .ml-3 > .text-gray-900'
    private ADIDAS_YEEZY_LABEL: string = ':nth-child(4) > :nth-child(1) > .flex > .ml-3 > .text-gray-900'
    private JORDAN_1_LOW_LABEL: string = ':nth-child(5) > :nth-child(1) > .flex > .ml-3 > .text-gray-900'
